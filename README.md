...
**Configure test_environment_linux.json with dynamodb Docker bridge ip**

To obtain the dynamodb bridge ip (IPAddress) we type : 
>docker inspect 'docker-name'
and include it on test_enviroment**.json 


**Launch python Script to create and populate schemas**
